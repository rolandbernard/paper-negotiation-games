...
\begin{figure*}
  ...
  \includegraphics[height=100pt]{clean_up/example_grid.pdf}\\
...
\subsection{Evaluation Metrics}\label{subsec:appendix_cleanup_evaluation_metric}
...
\begin{figure}[ht!]
    ...
    \begin{subfigure}{0.9\linewidth}
        \centering
        \includegraphics[width=\linewidth]{clean_up/clean_up_en.pdf}
        \caption{Results for each experiment for English.}
        \label{fig:cleanup_en}
    \end{subfigure}
    ...
    \begin{subfigure}{0.9\linewidth}
        \centering
        \includegraphics[width=\linewidth]{clean_up/clean_up_de.pdf}
        \caption{Results for each experiment for German.}
        \label{fig:cleanup_de}
    \end{subfigure}
    ...
    \begin{subfigure}{0.9\linewidth}
        \centering
        \includegraphics[width=\linewidth]{clean_up/clean_up_it.pdf}
        \caption{Results for each experiment for Italian.}
        \label{fig:cleanup_it}
    \end{subfigure}

    % --- Main caption for the entire figure ---
    \caption{Comparison of experimental results for English (top), German (middle), and Italian (bottom).}
    \label{fig:cleanup_all}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.45\textwidth]{clean_up/Main_Score_VS_level.png}
...
\begin{figure}
\centering
\includegraphics[width=0.45\textwidth]{clean_up/Sub_Scores_VS_levels.png}
...
\begin{figure}
\centering
\includegraphics[width=0.45\textwidth]{clean_up/Main_Score_VS_C_R.png}
...
\begin{figure}
\centering
\includegraphics[width=0.45\textwidth]{clean_up/Sub_Scores_VS_C_R.png}
