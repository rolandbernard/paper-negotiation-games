...
\begin{figure}[t]
    ...
    \caption{Quality and Played scores on \textit{Air Balloon Survival} instances for each each language. Scatters are annotated with acronyms of model names. `R' denotes reasoning model.}
    \label{fig:air-balloon-overall}
\end{figure}
...
\begin{minipage}{0.48\textwidth} % Adjusted width for longer model names
    ...
    \hline
    Claude 4 (no reasoning) & 0  & 13 & 13 \\
    Claude 4 (reasoning)                & 1  & 13 & 14 \\
    DeepSeek Chat v3.1                      & 11 & 12 & 23 \\
    DS-R1-Distill LLaMA-70B          & 1  & 0  & 1  \\
    ...
    Nemotron 9B (no reasoning)       & 21 & 1  & 22 \\
    Nemotron 9B (reasoning)                    & 0  & 2  & 2  \\
