...
Additionally, we employed an LLM-based analysis to identify the percentage of reasoning traces containing loops, where an action or thought is repeated at least three times, in 309 sampled transcripts, see \ref{sec:llm-based_reasoning_analysis}. Fig.~\ref{fig:reasoning_loops} shows that Claude-4 and GPT-OSS virtually never display loops in their traces and achieve high scores, whereas 34.3\% of the reasoning traces of Llama-70B and 54.4\% of  Nemotron-9B contain loops 
