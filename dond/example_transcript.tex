...
\begin{supertabular}{c@{$\;$}|p{.10\linewidth}@{}p{.15\linewidth}p{.20\linewidth}p{.20\linewidth}p{.15\linewidth}p{.10\linewidth}}
  ...
  \multicolumn{4}{p{0.7\linewidth}}{
    \cellcolor[rgb]{0.9,0.9,0.9}{
      \makecell[{{p{\linewidth}}}]{
        \tt{\tiny [A$\langle$GM]}
        <GAME DESCRIPTION> \\
        Available items: 1 book, 2 hats, 2 balls. \\
        Player A value function: book: 0, hat: 1, ball: 4.
      }
    }
  } & \\
  ...
  \multicolumn{4}{p{0.7\linewidth}}{
    \cellcolor[rgb]{0.9,0.9,0.9}{
      \makecell[{{p{\linewidth}}}]{
        \tt{\tiny [GM$\rangle$B]}
        <GAME DESCRIPTION> \\
        Player B value function: book: 6, hat: 1, ball: 1.
      }
    }
  } & \\
